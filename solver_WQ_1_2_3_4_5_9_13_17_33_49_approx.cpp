                                                             ...
                                                             const struct QPEP_options& opt)
{
    ...
    stat = GaussJordanElimination<__T>(C1_, data,
                                  data_func_WQ_1_2_3_4_5_9_13_17_33_49_approx,
                                  239, 27,
                                  opt, stat);
...
template struct QPEP_runtime solver_WQ_1_2_3_4_5_9_13_17_33_49_approx(Eigen::MatrixX<std::complex<float>>& sol_,
                                                                      const Eigen::VectorX<float>& data,
                                                                      const struct QPEP_options& opt);

template struct QPEP_runtime solver_WQ_1_2_3_4_5_9_13_17_33_49_approx(Eigen::MatrixX<std::complex<double>>& sol_,
                                                                      const Eigen::VectorX<double>& data,
                                                                      const struct QPEP_options& opt);

template struct QPEP_runtime solver_WQ_1_2_3_4_5_9_13_17_33_49_approx(Eigen::MatrixX<std::complex<long double>>& sol_,
