...
template void csdp_cov(Eigen::Matrix4<float>& cov,
                       const Eigen::MatrixX<float>& F,
                       const Eigen::Matrix3<float>& cov_left,
                       const Eigen::Vector4<float>& q);

template void csdp_cov(Eigen::Matrix4<double>& cov,
                       const Eigen::MatrixX<double>& F,
                       const Eigen::Matrix3<double>& cov_left,
                       const Eigen::Vector4<double>& q);

template void csdp_cov(Eigen::Matrix4<long double>& cov,
                       const Eigen::MatrixX<long double>& F,
                       const Eigen::Matrix3<long double>& cov_left,
