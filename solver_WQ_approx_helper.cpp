...
template void data_func_WQ_approx_sparse(Eigen::SparseMatrix<float>& tmp,
                                         Eigen::MatrixX<float>& tmp2,
                                         const Eigen::VectorX<float>& data);

template void data_func_WQ_approx_sparse(Eigen::SparseMatrix<double>& tmp,
                                         Eigen::MatrixX<double>& tmp2,
                                         const Eigen::VectorX<double>& data);

template void data_func_WQ_approx_sparse(Eigen::SparseMatrix<long double>& tmp,
                                         Eigen::MatrixX<long double>& tmp2,
